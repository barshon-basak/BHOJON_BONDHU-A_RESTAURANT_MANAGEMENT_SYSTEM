...
<header class="bg-primary shadow-lg">
  <div class="container mx-auto flex items-center justify-between px-6 py-4">
    ...
    <nav class="hidden md:flex space-x-8 text-white font-semibold">
      <?php if ($is_user_logged_in): ?>
          <a href="dashboard.php" class="hover:text-yellow-300 <?php echo $current_page === 'dashboard' ? 'text-yellow-300' : ''; ?>">Dashboard</a>
          <a href="restaurants.php" class="hover:text-yellow-300 <?php echo $current_page === 'restaurants' ? 'text-yellow-300' : ''; ?>">Restaurants</a>
          <a href="orders.php" class="hover:text-yellow-300 <?php echo $current_page === 'orders' ? 'text-yellow-300' : ''; ?>">My Orders</a>
          <a href="cart.php" class="relative hover:text-yellow-300 <?php echo $current_page === 'cart' ? 'text-yellow-300' : ''; ?>">
          ...
          <a href="profile.php" class="hover:text-yellow-300 <?php echo $current_page === 'profile' ? 'text-yellow-300' : ''; ?>">Profile</a>
  ...
  <div id="mobile-menu" class="hidden md:hidden bg-primary-dark text-white px-6 py-4 flex flex-col space-y-4 shadow-lg">
    <?php if ($is_user_logged_in): ?>
        ...
        <a href="restaurants.php" class="block hover:text-yellow-300">Restaurants</a>
        <a href="orders.php" class="block hover:text-yellow-300">My Orders</a>
        <a href="cart.php" class="block hover:text-yellow-300">Cart</a>
        <a href="profile.php" class="block hover:text-yellow-300">Profile</a>
        <a href="logout.php" class="block hover:text-yellow-300">Logout</a>
    <?php else: ?>
